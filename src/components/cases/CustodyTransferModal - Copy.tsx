          ...
          <>
            <div className="bg-cyan-50 border border-cyan-200 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-3">
                <Package className="w-5 h-5 text-cyan-700" />
                <span className="font-semibold text-cyan-900">Transfer Details</span>
              </div>
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-2">
                Seal Condition <span className="text-red-500">*</span>
              </label>
              <div className="flex gap-4">
                ...
                >
                  <CheckCircle2
                    className={`w-5 h-5 mx-auto mb-1 ${
                      sealIntact === true ? 'text-green-600' : 'text-slate-400'
                    }`}
                  />
                ...
                >
                  <AlertCircle
                    className={`w-5 h-5 mx-auto mb-1 ${
                      sealIntact === false ? 'text-red-600' : 'text-slate-400'
                    }`}
                  />
          ...
          <>
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-semibold text-red-900">Rejection Notice</span>
              </div>
