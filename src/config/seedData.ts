...
export const CLIENT_FINANCIAL_SEED_DATA = {
  ...
  master_quote_statuses: [
    ...
    { name: 'Follow-up Required', color: '#8b5cf6' },
  ...
  master_invoice_statuses: [
    ...
    { name: 'Partially Paid', color: '#8b5cf6' },
...
export const CASE_SERVICE_SEED_DATA = {
  ...
  master_case_statuses: [
    ...
    { name: 'Approved - In Queue', type: 'in-progress', color: '#8b5cf6' },
    { name: 'Recovery in Progress', type: 'in-progress', color: '#a855f7' },
    { name: 'Verification & QC', type: 'in-progress', color: '#9333ea' },
    { name: 'Data Transfer', type: 'ready', color: '#6366f1' },
