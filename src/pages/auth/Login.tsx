...
export const Login: React.FC = () => {
  ...
  const { signIn, signInWithGoogle, passwordResetRequired, profile, profileStatus } = useAuth();
      ...
      <div className="max-w-md w-full mx-4">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <button
            ...
            disabled={loading || googleLoading}
            className="w-full flex items-center justify-center gap-3 bg-white border border-slate-300 text-slate-700 py-2.5 rounded-md hover:bg-slate-50 transition-colors disabled:opacity-50 font-medium"
          >
