    ...
    <div className="space-y-5">
      ...
      >
        ...
        <input
          ...
          className="w-full bg-slate-800/50 border border-slate-700 rounded-xl px-4 py-3 text-white placeholder-slate-600 font-body text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/50 transition-all"
          autoFocus
        />
        {errors.companyName && (
          <p className="text-red-400 text-xs mt-1 font-body">{errors.companyName}</p>
        )}
      </motion.div>
      ...
      >
        ...
        <div className="flex items-center gap-2 mt-2 h-5">
          ...
          {!slugChecking && slugAvailable === false && (
            <motion.span
              initial={{ opacity: 0, x: -5 }}
              animate={{ opacity: 1, x: 0 }}
              className="flex items-center gap-1.5 text-xs text-red-400 font-body"
            >
        ...
        {errors.slug && (
          <p className="text-red-400 text-xs mt-1 font-body">{errors.slug}</p>
        )}
      </motion.div>
      ...
      >
        <Button
          ...
          className="w-full !bg-blue-600 hover:!bg-blue-500 !text-white !rounded-xl !py-3 !font-body disabled:!opacity-40"
        >
          Continue
        </Button>
      </motion.div>
