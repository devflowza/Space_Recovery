      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 border border-blue-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-medium text-blue-600 uppercase tracking-wide">Bank Balance</p>
              <p className="text-2xl font-bold text-blue-900 mt-1">
                {formatCurrencyValue(balanceSummary?.totalBankBalance || 0)}
              </p>
              <p className="text-xs text-blue-700 mt-1">{bankAccounts.length} accounts</p>
            </div>
        ...
        <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-4 border border-green-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-medium text-green-600 uppercase tracking-wide">Cash on Hand</p>
              <p className="text-2xl font-bold text-green-900 mt-1">
                {formatCurrencyValue(balanceSummary?.totalCashBalance || 0)}
              </p>
              <p className="text-xs text-green-700 mt-1">{cashAccounts.length} accounts</p>
            </div>
                ...
                accounts
                  ...
                  .map((account) => {
                    ...
                    const getAccountTypeColor = (type: string) => {
                      switch (type) {
                        case 'bank': return { bg: 'from-blue-50/50 to-blue-100/30', border: 'border-blue-200', accent: 'bg-blue-500' };
                        case 'cash': return { bg: 'from-green-50/50 to-green-100/30', border: 'border-green-200', accent: 'bg-green-500' };
                            ...
                            <div className="flex flex-col items-end justify-center gap-1 flex-shrink-0">
                              ...
                              <div className="text-right">
                                ...
                                {account.current_balance < 0 && (
                                  <div className="flex items-center justify-end gap-1 text-red-600 mt-0.5">
                          ...
                          <tr key={transaction.id} className="hover:bg-slate-50 transition-colors">
                            ...
                            <td className="py-2 px-4 text-right">
                              {transaction.debit_amount > 0 ? (
                                <span className="text-xs font-semibold text-red-600 flex items-center justify-end gap-1">
                                  <TrendingDown className="w-3 h-3" />
